...
(2) | modalidade_licitacao | Modalidade da Licitação | Anotar conforme os tipos: "Concorrência", "Registro de Preços", "Tomada de Preços", "Pregão Eletrônico", "Pregão Presencial", "Credenciamento", "RDC" etc
