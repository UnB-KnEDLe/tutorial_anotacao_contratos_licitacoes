...
(4) | tipo_objeto | Tipo de Objeto | Aparece dentro da label (4), Objeto da Licitação. Podem ser: "Alienação de Bens", "Aquisições", "Prestação de Serviços", "Concessão", "Permissão", "Locação", "Obras e serviços de engenharia"
